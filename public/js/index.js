...
socket.on("player-1-wins", ({myChoice, enemyChoice}) => {
    if(playerId === 1){
        let message = "Senin seçimin " + myChoice + ", ve karşı tarafın seçimi " + enemyChoice + " . Yani sen Kazandın!";
        setWinningMessage(message);
        myScorePoints++;
    }else{
        let message = "Senin seçimin " + myChoice + ", ve karşı tarafın seçimi " + enemyChoice + " . Yani sen Kaybettin!";
        setWinningMessage(message);
        enemyScorePoints++;
    }
...
function setPlayerTag(playerId){
    if(playerId === 1){
        playerOneTag.innerText = "Sen (Player 1)";
        playerTwoTag.innerText = "Dusman (Player 2)";
    }else{
        playerOneTag.innerText = "Dusman (Player 2)";
        playerTwoTag.innerText = "Sen (Player 1)";
    }
}
